            ...
            <div class="col-xl-12">
                ...
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('admin.services.store') }}" method="POST" enctype="multipart/form-data" class="row g-3" id="serviceAddForm">
                            @csrf
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea class="form-control" id="service_description" name="service_description" placeholder="Service Description" rows="4"></textarea>
                                </div>
                            </div>
            ...
            $.ajax({
                ...
                success: function (response) {
                    Swal.fire({
                        icon: "success",
                        title: "Success",
                        text: response.message || "Services Added Successfully!"
                    }).then(() => {
