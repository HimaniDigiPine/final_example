            ...
            <div class="col-xl-12">
                ...
                <div class="card">
                    <div class="card-body p-4">
                        <h5 class="mb-4">Category Insert</h5>
                        <form action="{{ route('admin.blog-categories.store') }}" method="POST" enctype="multipart/form-data" class="row g-3" id="categoryAddForm">
                            @csrf
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea class="form-control" id="category_small_description" name="category_small_description" placeholder="Small Description" rows="4"></textarea>
                                </div>
                            </div>
