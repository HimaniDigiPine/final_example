    ...
    <div class="main-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">General Options</li>
                    </ol>
                </nav>
            </div>
            <div class="ms-auto">
                <div class="btn-group">
                    <a href="{{ route('admin.theme_option_front.create') }}" class="btn btn-success px-4 raised d-flex gap-2">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <hr>
                <div class="btn-group">
                    <a href="{{ route('admin.theme_option_front.create') }}" class="btn btn-warning px-4 raised d-flex gap-2">
...
$(document).ready(function () {
    ...
    var table = $('#optionTable').DataTable({
        ...
        columnDefs: [
            ...
            { targets: 3, width: "190px" }, // Option Image column
            { targets: 4, width: "190px" }  // Action buttons column
        ],
        ajax: "{{ route('admin.theme_option_front.index') }}",
        columns: [
            {
                data: 'id',
