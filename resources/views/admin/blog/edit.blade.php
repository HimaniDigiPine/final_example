            ...
            <div class="col-xl-12">
                ...
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('admin.blog.update', $blog->id) }}" method="POST" enctype="multipart/form-data" class="row g-3" id="blogEditForm">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="blog_name" placeholder="Blog Title" name="blog_name" value="{{ old('blog_name', $blog->blog_name) }}">
                                </div>
                            </div>
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="blog_category_id" id="blog_category_id" class="form-control">
                                        ...
                                        @foreach($categories as $category)
                                            <option value="{{ $category->id }}" {{ $category->id == $blog->blog_category_id ? 'selected' : '' }}>{{ $category->category_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                @if($blog->feature_image)
                                    <div class="mt-2">
                                        <img src="{{ asset('uploads/blog/'.$blog->feature_image) }}" alt="Feature Image" width="120">
                                    </div>
                                @endif
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea class="form-control" id="blog_description" name="blog_description" placeholder="Write blog here..." rows="6">{{ old('blog_description', $blog->blog_description) }}</textarea>
                                </div>
                            </div>
